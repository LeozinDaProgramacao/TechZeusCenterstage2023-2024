...
@Disabled
@Autonomous(name="BlueBack2", group="BlueAuto")
public class BlueBack2 extends LinearOpMode {
    OpenCvWebcam webcam;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence midSequence = drive.trajectorySequenceBuilder(startPose)
                .splineToSplineHeading(new Pose2d(-35,21,Math.toRadians(90)),Math.toRadians(90))
                .waitSeconds(0.1)
                .UNSTABLE_addTemporalMarkerOffset(0,()->{
                    ArticulationMid();
                })
                ...
                .splineToConstantHeading(new Vector2d(45,41),Math.toRadians(180))
                .waitSeconds(0.5)
                ...
                .splineToConstantHeading(new Vector2d(60,14),Math.toRadians(20))
                .build();
